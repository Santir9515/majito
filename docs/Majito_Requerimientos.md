...
- **RF-14:** El sistema debe registrar cada movimiento de stock (entrada o salida, producto, cantidad, ticket asociado cuando corresponda, y fecha), de forma que sea posible reconstruir la trazabilidad del stock de un producto.
